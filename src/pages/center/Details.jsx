...
import { RightOutlined, SwapRightOutlined, SearchOutlined, CalendarOutlined, CloseOutlined } from '@ant-design/icons';
...
export default ({ scrolltop }) => {
    ...
    let Hearder = () => {
        return <div className="rowheader">
            ...
            <span style={{ textAlign: "center", flex: 1,fontSize:16 }}>选择出发日期</span>
            <CloseOutlined style={{color:"red",fontSize:16}} onClick={()=>{cshow(false)}}></CloseOutlined>
        </div>
    }
                    ...
                    >
                        ...
                        >
                            <div className="rows" style={{paddingTop:12}}>
                                <a className="diybtn" style={{ flex: 1 }} onClick={() => {
                                    alert(0)
                                }}>
                            ...
                            <Button size='large' icon={<SearchOutlined />} type='ghost' style={{ color: "#fff", backgroundColor: "rgb(253, 144, 147)", border: "none", width: "100%",marginBottom:12 }}>查询</Button>
                        </div>
                    </CSSTransition>
