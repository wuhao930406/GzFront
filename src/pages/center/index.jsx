  ...
  return (
    <div>
      <Modal
        ...
        footer={false}
      >
          <img style={{width:"100%"}} src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2488581882,381693902&fm=26&gp=0.jpg" alt=""/>
      </Modal>
      <List.Item className='totitle' style={{  padding: 24 }} onClick={()=>{
        ...
        <List.Item.Meta
          ...
          title={<a style={{ fontSize: 22, display: "block", margin: "6px 0",color:"#fff" }}>狗勇</a>}
