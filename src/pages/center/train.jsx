                ...
                <List.Item.Meta
                  title={
                    <a style={{
                      ...
                      <span className='estitle' style={{ flex:1 }}>{item.name}</span>
                      <span style={{  display: "block", width: 88, textAlign: "right",flexShrink:0}} >剩余 {item.max_people - item.enroll_people}座</span>
                    </a>
                  }
                  description={
